...
const TRANSLATIONS = {
  ...
  en: {
    ...
    confirmshamingTitle: "Confirmshaming detected",
    confirmshamingSub: "This page uses buttons designed to make you feel bad for declining — a manipulation tactic known as \"confirmshaming\".",
    confirmshamingLabel: "Shaming button text found",
  ...
  zh: {
    ...
    confirmshamingTitle: "检测到确认羞辱（Confirmshaming）",
    confirmshamingSub: "此页面使用了让你为「拒绝」感到愧疚的按钮设计——这是一种名为「确认羞辱」的操控手法。",
    confirmshamingLabel: "发现羞辱性按钮文字",
