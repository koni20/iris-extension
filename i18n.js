...
const TRANSLATIONS = {
  ...
  en: {
    ...
    antiGeoTitle: "GEO Optimization Detected",
    antiGeoSub: "This site uses structured markup to engineer its content for AI citations — results may be optimized for AI visibility, not human accuracy.",
    antiGeoTag: "GEO Signal",
    feedbackLink: "Report",
    feedbackTitle: "Report a missed or wrong detection",
  ...
  zh: {
    ...
    antiGeoTitle: "检测到 GEO 优化",
    antiGeoSub: "此网站使用了结构化标记，将内容专门针对 AI 引用进行优化——AI 给出的结果可能是被工程化设计过的，而非基于真实权威性。",
    antiGeoTag: "GEO 信号",
    feedbackLink: "反馈",
    feedbackTitle: "报告漏检或误报",
